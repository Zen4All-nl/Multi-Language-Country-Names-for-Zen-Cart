...
$module_constant = 'MULTI_LANGUAGE_COUNTRY_NAMES_VERSION'; // This should be a UNIQUE name followed by _VERSION for convention
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/multi_language_country_names'; // This is the directory your installer is in, usually this is lower case
$module_name = "Multi Language Country Names"; // This should be a plain English or Other in a user friendly way
$zencart_com_plugin_id = 2006; // from zencart.com plugins - Leave Zero not to check
