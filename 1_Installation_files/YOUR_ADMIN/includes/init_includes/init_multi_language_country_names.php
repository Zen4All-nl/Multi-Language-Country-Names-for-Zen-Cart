 ...
 * Part of the Zen4All Multi Language Country Names plugin
 *
 * Copyright (c) 2018 Zen4All
 */
...
$module_constant = 'MULTI_LANGUAGE_COUNTRY_NAMES_VERSION';
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/multi_language_country_names';
$module_name = 'Multi Language Country Names';
$module_file_for_version_check = '';
$zencart_com_plugin_id = 2006;
...
if (defined($module_constant)) {
  ...
  $db->Execute("INSERT INTO " . TABLE_CONFIGURATION_GROUP . " (configuration_group_title, configuration_group_description, sort_order, visible)
                VALUES ('" . $module_name . "', 'Set " . $module_name . " Options', '1', '1');");
